    ...
    <Shader
      source={`
        ...
        void main() {
            ...
            float animation_speed_factor = ${(function() {
              const match = shader.match(/animation_speed_factor_([\d.]+)_/);
              return match ? parseFloat(match[1]).toString() : "0.5";
            })()};
...
function MiniNavbar() {
  ...
  const signupButtonElement = (
    <div className="relative group w-full sm:w-auto">
      <div className="absolute inset-0 -m-2 rounded-full hidden sm:block bg-blue-300 opacity-40 filter blur-lg pointer-events-none transition-all duration-300 ease-out group-hover:opacity-60 group-hover:blur-xl group-hover:-m-3"></div>
      <button className="relative z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-blue-200 to-blue-400 rounded-full hover:from-blue-300 hover:to-blue-500 transition-all duration-200 w-full sm:w-auto">
        Signup
      </button>
    </div>
  );
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Your private workspace</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Protected by Telegram</p>
                    </div>
                    ...
                    <p className="text-xs text-white/40 pt-10">
                      ...
                      <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">MSA</Link>,{" "}
                      <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Product Terms</Link>,{" "}
                      <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Policies</Link>,{" "}
                      <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Privacy Notice</Link>, and{" "}
                      <Link href="#" className="underline text-white/40 hover:text-white/60 transition-colors">Cookie Notice</Link>.
                    </p>
                  </motion.div>
                ) : step === "code" ? (
                  <motion.div
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="py-10"
                    >
                      <div className="mx-auto w-16 h-16 rounded-full bg-gradient-to-br from-white to-blue-200 flex items-center justify-center">
