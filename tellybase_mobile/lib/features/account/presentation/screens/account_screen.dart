          ...
          children: [
            ...
            _SettingsTile(
              ...
              onTap: () => showAboutDialog(
                ...
                applicationLegalese: 'Private cloud storage. Your Telegram credentials remain on the server.',
              ),
            ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(contentPadding: EdgeInsets.zero, leading: Icon(Icons.key_off_outlined), title: Text('No Telegram secrets in the app'), subtitle: Text('Bot credentials stay in server-only modules.')),
              ],
            ),
          ),
        ),
